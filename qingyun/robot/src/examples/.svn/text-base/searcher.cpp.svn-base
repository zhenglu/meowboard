...
std::string Searcher::GetBestmove(Board & cur, PLAYER who)
{
    std::string buffer = "";
    //发给界面程序的着法字串及其long表示 
...
int Searcher::GameOver(Board & cur)
{
...
//    printf("line147,depth=%d,searchDepth=%d\n",depth,searchDepth);
    //用哈希树历史局面记录防止走出循环局面 
...
//    }
  ...
  //  printf("Line204\n");
    ...
    //        printf("line226,depth=%d,searchDepth=%d\n",depth,searchDepth);
