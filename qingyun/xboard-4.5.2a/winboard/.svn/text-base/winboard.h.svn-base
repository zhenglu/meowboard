...
VOID BoshInput(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);
VOID SubscriberInput(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

DWORD InputThread(LPVOID arg);
DWORD NonOvlInputThread(LPVOID arg);
DWORD SocketInputThread(LPVOID arg);
DWORD SocketInputThreadDummy(LPVOID arg);
