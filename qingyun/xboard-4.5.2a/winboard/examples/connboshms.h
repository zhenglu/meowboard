...
#ifndef CONNECTIONBOSHMS_H__
#define CONNECTIONBOSHMS_H__
...
namespace gloox
{
   ...
   * @since 1.0
   */
  class ConnBoshMultStat : public ConnectionBase, ConnectionDataHandler, TagHandler
  {
    public:
      /**
       ...
       */
      ConnBoshMultStat( ConnectionBase* connection, const LogSink& logInstance, const std::string& boshHost,
       ...
       * manager's.
       */
      ConnBoshMultStat( ConnectionDataHandler* cdh, ConnectionBase* connection,
    ...
    private:
      ConnBoshMultStat& operator=( const ConnBoshMultStat& );
