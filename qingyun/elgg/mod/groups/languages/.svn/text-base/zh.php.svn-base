...
$chinese = array( 
	 ...
	 'groups:widgets:description'  =>  "显示您参与的小组在您的档案里" , 
	 ...
	 'groups:privategroup'  =>  "这个小组是个人的，需要申请才能加入。" , 
	 ...
	 'groups:left'  =>  "成功离开了小组" , 
	 'groups:notowner'  =>  "抱歉您不是小组的所有者。" , 
	 'groups:notmember' => '抱歉您不是小组的成员。',
...
%s" , 
	 ...
	 'groups:allowhiddengroups'  =>  "你想允许私人小组(不可见)吗?" , 
	 'group:deleted'  =>  "小组和小组内容都删除了" , 
	 'group:notdeleted'  =>  "小组无法被删除" , 
